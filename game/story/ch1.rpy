...
label chapter_1_start:
    ...
    p_nvl "那时的我年龄尚小，什么也不懂，只是每天魂不守舍地将自己关在狭小的房间里哭个不停，完全不愿意接受现实。"
    ...
    p_nvl "不过，我并不在乎。"
    p_nvl "我唯一的念头就是念完高中，再找份工作，让祖母不要再过那么辛苦的日子。"
    p_nvl "然而，就是这个小小的愿望，我也无法实现。"
    p_nvl "一个月前，祖母也去世了。"
    nvl clear

    scene bg tap with squares
    ...
    $ renpy.pause(0.5, hard=True)
    nvl clear
    p_nvl "白纸上的小字模糊不清，唯有那两个黑色加重的字符如同滚烫的烙印，填满了视线。"
    ...
    play music "audio/bgm/BGM_004.mp3" fadein 0.5
